...
#define RN52_SET_AUDIO				"S|,0013"			// Sets the audio to analog out, 32bit, 48k sample rate
#define RN52_SET_MICGAIN			"SM,00001313"		// Sets microphone and line-in gain levels. 00 through 1F accepted.
